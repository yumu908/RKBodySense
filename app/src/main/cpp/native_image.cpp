...
Java_com_rockchips_bodysense_NativeImage_I420ToRGBAByte(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_I420ToRGBAInt(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_YV12ToRGBAByte(JNIEnv *env, jclass clazz,
                                                       jbyteArray src, jbyteArray dst,
                                                       jint width, jint height, jint yRowStride,
                                                       jint uvRowStride, jint uvPixelStride) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_YV12ToRGBAInt(JNIEnv *env, jclass clazz,
                                                      jbyteArray src, jintArray dst,
                                                      jint width, jint height, jint yRowStride,
                                                      jint uvRowStride, jint uvPixelStride) {
    jbyte *_src = env->GetByteArrayElements(src, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_NV12ToRGBAByte(JNIEnv *env, jclass clazz,
                                                       jbyteArray src, jbyteArray dst,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_NV12ToRGBAInt(JNIEnv *env, jclass clazz,
                                                      jbyteArray src, jintArray dst,
                                                      jint width, jint height) {
    jbyte *_src = env->GetByteArrayElements(src, NULL);
    jint *_dst = env->GetIntArrayElements(dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_NV21ToRGBAByte(JNIEnv *env, jclass clazz,
                                                       jbyteArray src, jbyteArray dst,
                                                       jint width, jint height) {
    jbyte *_src = env->GetByteArrayElements(src, NULL);
    jbyte *_dst = env->GetByteArrayElements(dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_NV21ToRGBAInt(JNIEnv *env, jclass clazz,
                                                      jbyteArray src, jintArray dst,
                                                      jint width, jint height) {
    jbyte *_src = env->GetByteArrayElements(src, NULL);
    jint *_dst = env->GetIntArrayElements(dst, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_rotateRGB(JNIEnv *env, jclass clazz,
                                                  jbyteArray src, jbyteArray dst,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_rotateRGBA(JNIEnv *env, jclass clazz,
                                                   jbyteArray src, jbyteArray dst,
                                                   jint width, jint height, jfloat degree) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_rotateRGBAInt(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_rotateYUV420P(JNIEnv *env, jclass clazz,
                                                      jbyteArray src, jbyteArray dst,
                                                      jint width, jint height, jfloat degree) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_rockchips_bodysense_NativeImage_rotateYUV420SP(JNIEnv *env, jclass clazz,
                                                       jbyteArray src, jbyteArray dst,
                                                       jint width, jint height, jfloat degree) {
    jbyte *_src = env->GetByteArrayElements(src, nullptr);
    jbyte *_dst = env->GetByteArrayElements(dst, nullptr);
